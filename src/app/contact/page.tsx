    ...
    return (
        <PageWrapperNormal>
            ...
            <div className="z-20 max-[680px]:w-full w-[600px] max-[680px]:ml-2 max-[680px]:mr-2 mt-24 mb-24 flex flex-col justify-between items-center gap-6">
                ...
                <div className="text-center max-[350px]:text-xl text-4xl font-extralight antialiased text-pink-500 rounded-xl px-5 py-1 text-shadow-lg/20 text-shadow-pink-500">
                    Contact me
                </div>
                <div className="flex max-[420px]:flex-col gap-5">
                    <Link
                        className="transition-all ease-in-out duration-300 border-2 p-2 w-[50px] h-[50px] rounded-full flex justify-center items-center hover:animate-pulse hover:scale-125 text-pink-500"
